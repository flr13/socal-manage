	...
	<div class="addEdit-block" :style='{"padding":"30px","background":""}' style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="社团/部门" prop="suoshushetuan">
					<el-input v-model="ruleForm.suoshushetuan" placeholder="社团/部门" clearable  :readonly="ro.suoshushetuan"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="社团/部门" prop="suoshushetuan">
					<el-input v-model="ruleForm.suoshushetuan" placeholder="社团/部门" readonly></el-input>
				</el-form-item>
			</template>
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='suoshushetuan'){
							this.ruleForm.suoshushetuan = obj[o];
							this.ro.suoshushetuan = true;
							continue;
						}
				}
