<template>
	<div class="menu-preview" style="background-color:rgba(248, 245, 254,0.75)">
		<!-- 竖向 -->
		<el-scrollbar wrap-class="scrollbar-wrapper" >
			<el-menu :default-openeds="[]" :unique-opened="true" :style='{"border":0,"padding":"0","listStyle":"none","margin":"0","position":"relative","background":"none"}' class="el-menu-vertical-demo" default-active="0">
				...
				<el-submenu index="0" @click.native="menuHandler('')" :style="this.$storage.get('role')!='管理员'?{ '--inputColor1': colorVal1,'--inputColor2': colorVal2}:{ '--inputColor1': colorVal1Admin,'--inputColor2': colorVal2Admin}">
					<template slot="title">
						<i v-if='true' :style='{"width":"34px","verticalAlign":"middle","margin":"0 3px","fontSize":"18px","color":"inherit","textAlign":"center"}' class="el-icon-menu el-icon-s-home" />
						<span :style='{"color":"inherit","verticalAlign":"middle","fontSize":"14px"}'>系统首页</span>
					</template>
				...
				<div :style="this.$storage.get('role')!='管理员'?{ '--inputColor1': colorVal1,'--inputColor2': colorVal2}:{ '--inputColor1': colorVal1Admin,'--inputColor2': colorVal2Admin}">
				<el-submenu index="1"  >
					<template slot="title">
					...
					<el-submenu index="2"  >
						<template slot="title">
							<i v-if='true' :style='{"width":"34px","verticalAlign":"middle","margin":"0 3px","fontSize":"18px","color":"inherit","textAlign":"center"}' class="el-icon-menu el-icon-user-solid" />
							<span :style='{"color":"inherit","verticalAlign":"middle","fontSize":"14px"}'>数据中心</span>
						</template>
						<el-menu-item index="1-1" @click="menuHandler('data')" >数据统计</el-menu-item>
					</el-submenu>
				<el-submenu v-for=" (menu,index) in menuList.backMenu" :key="menu.menu" :index="index+3+''" >
					<template slot="title">
...
export default {
	data() {
		return {
			colorVal1: '#f56c6c',
			colorVal2: '#FF8D62',
			colorVal1Admin: '#038afb',
			colorVal2Admin: '#0c5592',
			menuList: [],
			dynamicMenuRoutes: [],
			role: '',
			icons: [
	...
	.menu-preview {
	  .el-scrollbar {
		...
		.el-menu-vertical-demo .el-submenu /deep/ .el-submenu__title {
						...
						color: #fff;
						white-space: nowrap;
						background: -webkit-linear-gradient(top,var(--inputColor1),var(--inputColor1));
						position: relative;
					}

		.el-menu-vertical-demo .el-submenu /deep/ .el-submenu__title:hover {
						color: black;
						background: -webkit-linear-gradient(top,var(--inputColor2),var(--inputColor2));
					}
